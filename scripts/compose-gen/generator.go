...
func writeFilterAmtQ5(b *strings.Builder, cfg *Config) {
	for i := range cfg.FilterAmtQ5 {
		...
		fmt.Fprintf(b, "      - LEFT_INPUT_QUEUE=Q5_fetcher_output_%d\n", i)
		b.WriteString("      - RIGHT_INPUT_QUEUE=Q5_filtered_filter_q\n")
		b.WriteString("      - RIGHT_INPUT_EXCHANGE=Q5_filtered_exchange\n")
		b.WriteString("      - RIGHT_INPUT_ROUTING_KEYS=Q5_TRANSFERS_KEY\n")
