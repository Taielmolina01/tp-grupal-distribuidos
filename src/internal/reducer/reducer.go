...
func (reducer *Reducer[T]) Run() {
	...
	if err := reducer.inputExchange.StartConsuming(func(msg newmiddleware.Message, ack, nack func()) {
...
func (reducer *Reducer[T]) handleMessage(msg newmiddleware.Message, ack func(), nack func()) {
	defer ack()
